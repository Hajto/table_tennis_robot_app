...
- [x] Delayed start — a get-in-position countdown (default 10s) before the drill begins, with last-3s beeps and a higher "go" tone at zero (sound toggle in Settings)
